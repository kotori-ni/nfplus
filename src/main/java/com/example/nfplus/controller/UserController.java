 ...
 * @LastEditors: wch
 * @LastEditTime: 2023-08-16 10:18:03
 */
...
public class UserController {
    ...
    public ResultUtils updateUser(@RequestHeader("Authorization") String token, @RequestBody User user) {
        ...
        if (!existUser.getUsername().equals(user.getUsername()) && userService.query().eq("username", user.getUsername()).count() > 0)
